...
public class ChatControlTest extends Mockito{
	...
	public void testDoPostHttpServletRequestHttpServletResponse() throws IOException, ServletException {
        ...
        String mockString = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        		...
        		+ "<message><id>0</id><date>2015-12-07</date><time>18:21:10</time><name>Niels</name><nachricht>Guten Abend</nachricht>"
        		+ "</message></messages>";

        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(mockString.getBytes(StandardCharsets.UTF_8));
        ...
        assertTrue(str.contains("<message><id>1</id><date>2015-12-07</date><time>18:21:10</time><name>Niels</name><nachricht>Guten Abend</nachricht></message>"));
	}
